...
$routes->group('scan', function (RouteCollection $routes) {
   ...
   $routes->get('statistik', 'Scan::statistik');
...
/*
 * --------------------------------------------------------------------
 * Test Routes (Temporary - Hapus setelah selesai testing)
 * --------------------------------------------------------------------
 */

// $routes->get('test-scan-wa', function() {
//     try {
//         $token = env('WHATSAPP_TOKEN');
        
//         if (empty($token)) {
//             echo "ERROR: WHATSAPP_TOKEN tidak ditemukan di file .env";
//             return;
//         }
        
//         echo "<h3>Testing WhatsApp Notification</h3>";
...
//         $message = [
//             [
//                 'destination' => '6282253054705', // Pastikan nomor ini benar
//                 'message' => "Test notifikasi dari localhost - " . date('Y-m-d H:i:s'),
//                 'delay' => 0
//             ]
//         ];
        
//         echo "Mengirim pesan dengan format:<br>";
//         echo "<pre>";
//         print_r($message);
//         echo "</pre><br>";
...
//         echo "<h3>Hasil Pengiriman:</h3>";
//         echo "Result: <strong>" . $result . "</strong><br><br>";
        
//         if (strpos($result, 'Sukses') !== false || strpos($result, 'success') !== false) {
//             echo "<p style='color: green;'>✅ Notifikasi berhasil dikirim! Cek WhatsApp Anda.</p>";
//         } else {
//             echo "<p style='color: red;'>❌ Gagal mengirim: " . $result . "</p>";
//         }
